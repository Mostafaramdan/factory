...
use App\Models\variable_costs;
use App\Models\matrials_types;
...
class dashboard extends Controller
{
    ...
    public static function getProduction_materials()
    {
        return response()->json([
            'variable_costs'=>variable_costs::all(),
            'matrials_types'=>matrials_types::all(),
        ]);
    }
}
